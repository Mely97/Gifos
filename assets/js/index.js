...
function prepareSearch() {
    ...
    if (searchInputValue) {
        ...
        getSearchResults(searchInputValue)
            .then(response => loadSearchPage(response))
...
//Función que me traiga Hashtags
...
function onSearchInputKeydown(event) {
    if (event.keyCode === 13) { // Envia la busqueda cuando oprimo  enter
...
//Carga de gif por gif del arreglo de LIMITGIFS
